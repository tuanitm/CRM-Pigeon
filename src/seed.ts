...
const demoCustomers = [
  {
    ...
    orderCount: 12,
    totalSpend: 15800000,
    lastOrder: '28/07/2026',
    babies: [{ name: 'Bé An', stageCode: 'INFANT' }],
    flag: null,
  },
  {
    id: 'b2c3d4e5',
  ...
  },
  {
    ...
    orderCount: 1,
    totalSpend: 450000,
    lastOrder: '20/07/2026',
    babies: [
      { name: 'Bé Bình', stageCode: 'NEWBORN' },
      { name: 'Bé Châu', stageCode: 'TODDLER' },
    ],
    flag: 'missing_email',
  },
  {
  ...
  },
  {
    ...
    orderCount: 8,
    totalSpend: 10400000,
    lastOrder: '27/07/2026',
    babies: [{ name: 'Bé Dũng', stageCode: 'INFANT' }],
    flag: null,
  },
  {
    id: 'f6a7b8c9',
    ...
    orderCount: 15,
    totalSpend: 22000000,
    lastOrder: '29/07/2026',
    babies: [],
    flag: null,
  },
  {
    id: 'g7b8c9d0',
    fullName: 'Bui Thi Thuy',
    phone: '+84967890123',
    email: null,
    gender: 'Nữ',
    source: 'Walk-in',
  ...
  for (const c of demoCustomers) {
    ...
    await prisma.customer.create({
      data: {
        ...
        loyaltyAccount: {
          create: {
            tierId: tiers[c.tier as keyof typeof tiers] || bronze.id,
