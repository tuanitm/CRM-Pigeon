...
let EventsController = class EventsController {
    ...
    async ingestEvents(dto, _idempotencyKey) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Ingest batch of events (max 100)' }),
    (0, swagger_1.ApiHeader)({ name: 'Idempotency-Key', required: false }),
    (0, swagger_1.ApiResponse)({ status: 202, description: 'Events accepted for processing' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Headers)('idempotency-key')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [events_dto_1.BatchEventsDto, String]),
    __metadata("design:returntype", Promise)
], EventsController.prototype, "ingestEvents", null);
